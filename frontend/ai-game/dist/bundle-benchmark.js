...
_axios2.default.get(_config2.default.rest['benchmark']).then(function (res) {
  var data = res.data['data'];
  var html = (0, _createRankItem2.default)(data, 'benchmark');
  document.querySelector('#rank').innerHTML = html;
}).catch(function (err) {});

/***/ })
/******/ ]);
//# sourceMappingURL=bundle-benchmark.js.map