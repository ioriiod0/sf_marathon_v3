...
function createEnv(envs, type) {
  return envs.reduce(function (str, env) {
...
function createItems(data, type) {
  return data.reduce(function (str, item) {
    var env = createEnv(item.envs, type);
...
_axios2.default.get(_config2.default.rest['competition']).then(function (res) {
  var data = res.data['data'];
  var html = (0, _createRankItem2.default)(data, 'competition');
  document.querySelector('#rank').innerHTML = html;
}).catch(function (err) {});

/***/ })
/******/ ]);
//# sourceMappingURL=bundle-competition.js.map